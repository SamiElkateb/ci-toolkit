...
\t\t init \t\t initializes ci-toolkit by creating default config files`,
  ...
  shouldCommitSomeFilesAreUntracked: () => 'Should commit but some untracked files are not staged for commit.',
  continueNoCommit: () => 'Continue without committing?',
  continueCommitStaged: () => 'Continue and commit only staged changes?',
  continueWithoutCommittingUntracked: () => 'Continue without commiting untracked files?',
