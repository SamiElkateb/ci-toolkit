const ERROR_MESSAGES = {
    ...
    shouldStartWith: (property: string) =>
        `${property} is a variable and should start with $_`,
    shouldBeValidPath: (property: string) =>
        `${property} should be a valid file path`,
    shouldBeValidPaths: (property: string) =>
        `${property} should be a valid file paths`,
    shouldBeArrayOfStrings: (property: string) =>
